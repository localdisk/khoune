<nav class="bg-gray-800 flex items-center">
  ...
  <div class="flex flex-grow items-center justify-end">
    ...
    <div x-data="{ open: false }" @click.away="open = false">
      ...
      <div class="absolute right-auto z-10 rounded shadow border-gray-100 w-40" x-show="open">
        <a class="block cursor-pointer hover:bg-gray-100 p-2">One</a>
        <a class="block cursor-pointer hover:bg-gray-100 p-2">Two</a>
      </div>
    </div>{{-- dropdown --}}
